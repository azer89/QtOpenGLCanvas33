...
QT_MOC_LITERAL(1, 12, 14), // "VScrollChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "val"
QT_MOC_LITERAL(4, 32, 14), // "HScrollChanged"
QT_MOC_LITERAL(5, 47, 13) // "DummyFunction"

    },
    "GLContainer\0VScrollChanged\0\0val\0"
    "HScrollChanged\0DummyFunction"
};
...
void GLContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->VScrollChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->HScrollChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->DummyFunction(); break;
        default: ;
        }
    }
}
...
const QMetaObject GLContainer::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_GLContainer.data,
      qt_meta_data_GLContainer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
